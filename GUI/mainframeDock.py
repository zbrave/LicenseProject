...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.songListWidget.item(0)
        item.setText(_translate("MainWindow", "sadasd"))
        item = self.songListWidget.item(1)
        item.setText(_translate("MainWindow", "dsdddd"))
        item = self.songListWidget.item(2)
        item.setText(_translate("MainWindow", "sadasd"))
