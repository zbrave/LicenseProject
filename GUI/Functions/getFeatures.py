...
def features(dirpath):
    ...
    List=[zcr,vzcr,centroid,vcentroid,contrast,vcontrast,rollof,vrollof,bandwidth,vbandwidth,mfcc1,vmfcc1,mfcc2,vmfcc2,mfcc3,vmfcc3,mfcc4,vmfcc4,mfcc5,vmfcc5,mfcc6,vmfcc6,mfcc7,vmfcc7,mfcc8,vmfcc8,mfcc9,vmfcc9,mfcc10,vmfcc10,mfcc11,vmfcc11,mfcc12,vmfcc12,mfcc13,vmfcc13,mcqt1,vcqt1,mcqt2,vcqt2,mcqt3,vcqt3,mcqt4,vcqt4,mcqt5,vcqt5,mcqt6,vcqt6,mcqt7,vcqt7,mcqt8,vcqt8,mcqt9,vcqt9,mcqt10,vcqt10,mcqt11,vcqt11,mcqt12,vcqt12,mtonnetz1,vtonnetz1,mtonnetz2,vtonnetz2,mtonnetz3,vtonnetz3,mtonnetz4,vtonnetz4,mtonnetz5,vtonnetz5,mtonnetz6,vtonnetz6]
    return List